 ...
 */
public class ClientsGenerator extends ExternalEvent {
	...
	*/
	 ...
	 * @param arg3 boolean
	 */
	public ClientsGenerator(Model owner, String name, boolean showInReport) {
	...
	public void eventRoutine() {
		...
		Clients newClient = new Clients(myModel, "Client", true);
		...
		this.schedule(new TimeSpan(myModel.getClientArrivalTime()));
		...
		myModel.clientsArrived.update(++myModel.arrivedClients);
	}
}
